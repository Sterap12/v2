        ...
        <div class="content-page-container full-reset custom-scroll-containers">
            ...
            <div class="container">
                <div class="page-header">
                    <h1 id="titulitos" >Sistema Nove<small>  Administración Inventario</small></h1>
                </div>
            </div>
            <div class="container-fluid">
                <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                    <li role="presentation"  class="active"><a href="registrar_inventario.jsp">Registrar Inventario</a></li>
            ...
            <div class="container-fluid"  style="margin: 50px 0;">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                        Bienvenido a la sección para nuevo inventario en el aula de clases, debes de llenar todos los campos del siguiente formulario para registrar inventario.
                    </div>
                </div>
            </div>
            <div class="container-fluid">
            ...
            <div class="container-fluid">
                <div class="container-flat-form">
                    <div class="title-flat-form title-flat-blue">Registrar Inventario</div>
                    <form autocomplete="off" method="post" action="Inventario">
                        <div class="row">
                            <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                                <div class="group-material">
                                    <input name="textinvType" type="text" class="material-control tooltips-general" placeholder="Tipo Inventario" required="" maxlength="70" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,70}" data-toggle="tooltip" data-placement="top" title="Falta Escribir El Tipo Inventario" autofocus onkeypress="return soloLetras(event)">
                                ...
                                <div class="group-material">
                                    <input name="textinvName"  type="text" class="material-control tooltips-general input-check-user" placeholder="Nombre Inventario" required="" maxlength="20" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ]{1,20}" data-toggle="tooltip" data-placement="top" title="Falta Escribir el Nombre" onkeypress="return soloLetras(event)">
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
                                    <label>Nombre Inventario</label>
                                </div>
                                <div class="group-material">
                                    <input name="textserial"  type="text" class="material-control tooltips-general input-check-user" placeholder="Nombre Inventario" required="" maxlength="20" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ]{1,20}" data-toggle="tooltip" data-placement="top" title="Falta Escribir el Nombre" >
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
                                    <label>Serial</label>
                                </div>
                                <div class="group-material">
                                    <input name="textidentificador"  type="text" class="material-control tooltips-general input-check-user" placeholder="Nombre Inventario" required="" maxlength="20" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ]{1,20}" data-toggle="tooltip" data-placement="top" title="Falta Escribir el Nombre" >
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
                                    <label>Serial Sena</label>
                                </div>
                                <div class="group-material">
                                    <input name="textmodelo"  type="text" class="material-control tooltips-general input-check-user" placeholder="Nombre Inventario" required="" maxlength="20" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ]{1,20}" data-toggle="tooltip" data-placement="top" title="Falta Escribir el Nombre" >
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
                                    <label>Modelo</label>
                                </div>
                                <div class="group-material">
                                    <h4>Salon</h4>
                                    <select class="material-control tooltips-general"  required="" pattern="[0-9]{8,8}" maxlength="10" data-toggle="tooltip" data-placement="top" title="Solo números, mínimo 8 dígitos" name="textsalon" >
