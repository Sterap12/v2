        ...
        <div class="content-page-container full-reset custom-scroll-containers">
            ...
            <div class="container">
                <div class="page-header">
                    <h1 class="all-tittles">Sistema Novedades<small>Administración Estacion</small></h1>
                </div>
            </div>
            ...
            <div class="container-fluid"  style="margin: 50px 0;">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                        Bienvenido a la sección para registrar una nueva estación, debes de llenar todos los campos del siguiente formulario para poder registrar un estación.
                    </div>
                </div>
            </div>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-12 lead">
                        <ol class="breadcrumb">
                            <li class="active">Estación</li>
                            <li><a href="#">Listado de Estaciones</a></li>
                        </ol>
                    </div>
                </div>
            </div>
            <div class="container-fluid">
                <div class="container-flat-form" >
                    <div class="title-flat-form title-flat-blue">Agregar una nueva estación</div>
                    <form autocomplete="off" method="post" action="Estacion">
                        <div class="row">
                            <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                                <div class="group-material">
                                    <input type="text" class="material-control tooltips-general" placeholder="Tipo de Estacion" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="Falta poner el tipo" name="textintype" autofocus onkeypress="return soloLetras(event)">
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
                                    <label>Tipo</label>
                                </div>
                                <div class="group-material">
                                    <input type="text" class="material-control tooltips-general" placeholder="Cantidad" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="Falta agegar la cantidad" name="textquantity_Sta">
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
                                    <label>Cantidad</label>
                                </div>
                                <div class="group-material">
                                    <input type="text" class="material-control tooltips-general" placeholder="Objeto Estacion" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="Falta agregar el objeto" name="textobject_Sta">
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
                                    <label>Objecto</label>
                                </div>
                                <div class="group-material">
                                    <select class="material-control tooltips-general" placeholder="Apellido de Instructor" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe el apellido del aprendiz" name="textId_Cla">
                                        <option style="color:lightgrey">Classroom</option>
                                        ...
                                        %>
                                        <option value="<%= instivo.getClId()%>"  >  <%= instivo.getClNumber()%></option>
                                        <% }%>
                                    </select><br><br>
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
                                ...
                                <div class="group-material">
                                    <select class="material-control tooltips-general" placeholder="Seleccione el Inventario" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="Seleccione el Inventario" name="textid_inv">
                                        <option style="color:lightgrey">Inventario</option>
                                        <%
