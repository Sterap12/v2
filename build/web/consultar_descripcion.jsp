...
<html>
    <head>
        ...
        <link href="style_vehiculo.css" rel="stylesheet" type="text/css"/>
        ...
        <div class="content-page-container full-reset custom-scroll-containers">
            ...
            <div class="container">
                <div class="page-header">
                    <h1 id="titulitos" >Sistema Novedades<small>  Administración Descripcion</small></h1>
                </div>
            </div>
            <div class="container-fluid">
                <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                    <li role="presentation"><a href="registrar_descripcion.jsp">Registrar Descripción</a></li>
                    <li role="presentation" class="active"><a href="consultar_descripcion.jsp">Consultar Descripción</a></li>
            ...
            <div class="container-fluid"  style="margin: 50px 0;">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                        Bienvenido a la sección descipción en el aula de clases, debes de llenar el campo con la fecha respectiva para consultar una descripcion formulario para consultar descripción.
                    </div>
                </div>
            </div>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-12 lead">
                        <ol class="breadcrumb">
                            ...
                            <li><a href="#">Listado Descripción</a></li>
                        </ol>
                    </div>
                </div>
            </div>
            <div class="container-fluid">
                <div class="container-flat-form">
                    <div class="title-flat-form title-flat-blue">Descripción</div>
                    <form autocomplete="off" method="post" action="Descripcion">
                        <div class="row">
                            <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                                <div class="group-material">
                                    <input name="textdesDate" type="date" class="material-control tooltips-general" placeholder="Describir novedad" required="" maxlength="70" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,70}" data-toggle="tooltip" data-placement="top" title="Selecciona el id de la novedad">
