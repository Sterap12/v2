...
<%@page import="modeloVO.DescripcionVO"%>
        ...
        <div class="content-page-container full-reset custom-scroll-containers">
            ...
            <div class="container">
                <div class="page-header">
                    <h1 id="titulitos" >Sistema Nova<small>  Administración Descripción</small></h1>
                </div>
            </div>
            <div class="container-fluid">
                <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                    <li role="presentation"  class="active"><a href="registrar_descripcion.jsp">Registrar Descripción</a></li>
                    <li role="presentation"><a href="consultar_descripcion.jsp">Consultar Descripción</a></li>
                </ul>
            </div>
            <div class="container-fluid"  style="margin: 50px 0;">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                        Bienvenido a la sección descripción en el aula de clases, debes de llenar todos los campos del siguiente formulario para registrar descripción.
                    </div>
                </div>
            </div>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-12 lead">
                        <ol class="breadcrumb">
                            ...
                            <li><a href="#">Registro Descripción</a></li>
                        </ol>
                    </div>
                </div>
            </div>
            <div class="container-fluid">
                <div class="container-flat-form">
                    <div class="title-flat-form title-flat-blue">Registrar Descripción</div>
                    <form autocomplete="off" method="post" action="Descripcion">

                        <div class="row">
                            <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                                <div class="group-material">
                                    <div class="group-material">
                                        <input name="textdesReason" type="textarea" class="material-control tooltips-general" placeholder="Descripcion" required="" maxlength="200" data-toggle="tooltip" data-placement="top" title="Falta Escribe La Descripcion" autofocus>
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
                                        <label>Descripción</label>
                                    </div>
                                    <div class="group-material">
                                        <select name="textdesIdPro" type="text" class="material-control tooltips-general" placeholder="Id Estacion" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="Falta elegir la estacion">
                                            
                                           <% EstacionVO EstVO = new EstacionVO();
                                           EstacionDAO EstDAO = new EstacionDAO();
                                           
                                          ArrayList<EstacionVO> listaObjetos = EstDAO.listar();
                                          
                                          for (int i=0; i < listaObjetos.size(); i++){
                                          
                                          EstVO = listaObjetos.get(i);
                                           %> <option value="<%=EstVO.getPA_Id_Sta()%>"<option>
                                    ...
                                    <div class="group-material">
                                        <input name="textdesDate" type="date" class="material-control tooltips-general" placeholder="Apellido de Instructor" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="Falta poner la Fecha">
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
                                        <label>Fecha</label>
                                    </div>
