            ...
            try {
              ...
              rs = st.executeQuery("SELECT * FROM instructor");
                ...
                if (con!=null) {
                 ...
                 par1.add( new Phrase("Reporte Instructor",fontitulo));
               ...
               //  Image imagenes = Image.getInstance("URL DE LA IMAGEN");
                ...
                PdfPCell celda4 = new PdfPCell(new Paragraph("Tipo de documento",FontFactory.getFont("Arial", 12, Font.BOLD, BaseColor.BLACK)));
                PdfPCell celda5 = new PdfPCell(new Paragraph("Numero",FontFactory.getFont("Arial", 12, Font.BOLD, BaseColor.BLACK)));
                PdfPCell celda6 = new PdfPCell(new Paragraph("Especialidad",FontFactory.getFont("Arial", 12, Font.BOLD, BaseColor.BLACK)));
                PdfPCell celda9 = new PdfPCell(new Paragraph("Correo",FontFactory.getFont("Arial", 12, Font.BOLD, BaseColor.BLACK)));
