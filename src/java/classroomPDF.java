 ...
 * @author kathe
 */
@WebServlet(urlPatterns = {"/classroomPDF"})
public class classroomPDF extends HttpServlet {
            ...
            try {
              ...
              rs = st.executeQuery("SELECT * FROM classroom");
                ...
                if (con!=null) {
                 ...
                 par1.add( new Phrase("Reporte salones",fontitulo));
                ...
                PdfPCell celda2 = new PdfPCell(new Paragraph("Tipo de salon",FontFactory.getFont("Arial", 12, Font.BOLD, BaseColor.BLACK)));
                PdfPCell celda3 = new PdfPCell(new Paragraph("Numero",FontFactory.getFont("Arial", 12, Font.BOLD, BaseColor.BLACK)));
