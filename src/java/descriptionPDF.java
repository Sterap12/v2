 ...
 * @author kathe
 */
@WebServlet(urlPatterns = {"/descriptionPDF"})
public class descriptionPDF extends HttpServlet {
...
protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
              ...
              rs = st.executeQuery("SELECT * FROM descriptionofcomponents");
                ...
                if (con!=null) {
                 ...
                 par1.add( new Phrase("Reporte Descripcion",fontitulo));
               ...
               //  Image imagenes = Image.getInstance("URL DE LA IMAGEN");
                ...
                PdfPCell celda2 = new PdfPCell(new Paragraph("Razon",FontFactory.getFont("Arial", 12, Font.BOLD, BaseColor.BLACK)));
                PdfPCell celda3 = new PdfPCell(new Paragraph("Proceso",FontFactory.getFont("Arial", 12, Font.BOLD, BaseColor.BLACK)));
